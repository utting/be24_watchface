...
public class CalendarViewer {
    ...
    public void showCalendars(Context context) {
        try {
            ...
            Log.i(DEBUG_TAG, "Exception: " + ex.getLocalizedMessage());
//            String msg = "Please enable calendar permissions." + ex.getLocalizedMessage();
//            Snackbar warnSnackbar = Snackbar.make(context, msg, Snackbar.LENGTH_SHORT);
//            warnSnackbar.show();
        }
    }
    ...
    public void showDay(Context context) {
        try {
            ...
            Log.i(DEBUG_TAG, "Exception: " + ex.getLocalizedMessage());
//            String msg = "Please enable calendar permissions. " + ex.getLocalizedMessage();
//            Snackbar warnSnackbar = Snackbar.make(null, msg, Snackbar.LENGTH_SHORT);
//            warnSnackbar.show();
        }
    }
}
